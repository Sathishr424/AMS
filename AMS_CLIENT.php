...
<html>
    ...
    <body>
        ...
        <div class='container'>
            ...
            ?>
            <!-- <div class='card' onclick="exportAttendance()">
                <img src='attendance.png'/>
                <div>Export Attendance</div>
            </div> -->
        </div>
    ...
    <script>
        ...
        var peroids = [
            ...
            [{name: 'DBMS/', period: '2', periodStart:1},{name: 'WT LAB', period: '2', periodStart:3},{name: 'AI', period: '1', periodStart:5},{name: 'PS', period: '1', periodStart:6},{name: 'IPS LAB', period: '2', periodStart:8}],
...
//
        ...
        function CreatePDFfromHTML() {
            var HTML_Width = $("#VA_TABLE").width();
            var HTML_Height = $("#VA_TABLE").height();
            ...
            html2canvas($("#VA_TABLE")[0]).then(function (canvas) {
